...
const DashboardSidebar = ({ open, onClose }) => {
  ...
  const sidebarWidth = '35vw'; // 35% szerokości ekranu
  const sidebarMinWidth = 400; // Minimalna szerokość
  const sidebarMaxWidth = 600; // Maksymalna szerokość
              ...
              >
                <ListItemIcon sx={{ minWidth: 50 }}>
                  <Box
                    sx={{
                      p: 1,
                      borderRadius: 2,
                      background: state.uiState.activePanel === panel.id
                ...
                <ListItemText
                  ...
                  primaryTypographyProps={{
                    variant: 'body1',
                    fontWeight: state.uiState.activePanel === panel.id ? 700 : 600,
                    sx: { mb: 0.5 }
                  }}
                  secondaryTypographyProps={{
                    ...
                    sx: {
                      fontSize: '0.8rem',
                      lineHeight: 1.3,
                      color: state.uiState.activePanel === panel.id ? zusColors.primary : 'text.secondary'
                    },
                  }}
                />
